    ...
    <div class="" style="margin: 0">
      <el-col :span="24">
        <el-card style="margin-bottom: 10px">
          ...
          1 / 10
          <el-button style="float: right; margin-top: -10px" type="primary" icon="el-icon-switch-button" :loading="loading" @click="handHandExam()">
            {{ handleText }}
          </el-button>
